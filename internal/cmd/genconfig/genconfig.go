...
func writeMaxVersionsScripts() {
	...
	writeFileFromTmpl(".github/workflows/vim_main.yml", mainWorkflowYaml, vs)
}
...
const mainWorkflowYaml = `# Code generated by genconfig. DO NOT EDIT.
on:
  push:
    branches:
      - main
...
jobs:
  test:
    ...
    - name: Run main tests
      run: ./_scripts/testVimMain.sh {{{ .MaxVimVersion }}} ${{ github.event_name }}
`
