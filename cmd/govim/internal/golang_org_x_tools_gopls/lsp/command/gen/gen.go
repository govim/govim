...
import (
	...
	"github.com/govim/govim/cmd/govim/internal/golang_org_x_tools_gopls/lsp/command/commandmeta"
)
...
func Generate() ([]byte, error) {
	...
	d := data{
		...
		Imports: map[string]bool{
			"context": true,
			"fmt":     true,
			"github.com/govim/govim/cmd/govim/internal/golang_org_x_tools_gopls/lsp/protocol": true,
		},
	}
	const thispkg = "github.com/govim/govim/cmd/govim/internal/golang_org_x_tools_gopls/lsp/command"
