...
func Generate() ([]byte, error) {
	...
	d := data{
		...
		Imports: map[string]bool{
			"context": true,
			"fmt":     true,
			"github.com/govim/govim/cmd/govim/internal/golang_org_x_tools/lsp/protocol": true,
		},
	}
	const thispkg = "github.com/govim/govim/cmd/govim/internal/golang_org_x_tools/lsp/command"
