...
import (
	myFoo "github.com/myitcv/govim/cmd/govim/internal/lsp/foo" //@godef("foo", PackageFoo),godef("myFoo", PackageFoo)
	"github.com/myitcv/govim/cmd/govim/internal/lsp/godef/a"   //@mark(AImport, "\"")
)
