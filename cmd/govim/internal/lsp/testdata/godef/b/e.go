...
definition(bStructType, "-emulate=guru", Thing, "$file:$line:$col: defined here as type github.com/myitcv/govim/cmd/govim/internal/lsp/godef/a.Thing")
...
definition(bVar, "-emulate=guru", Other, "$file:$line:$col: defined here as var github.com/myitcv/govim/cmd/govim/internal/lsp/godef/a.Other")

definition(bFunc, "", Things, "$file:$line:$col-$ecol: defined here as func a.Things(val []string) []a.Thing")
definition(bFunc, "-emulate=guru", Things, "$file:$line:$col: defined here as func github.com/myitcv/govim/cmd/govim/internal/lsp/godef/a.Things(val []string) []github.com/myitcv/govim/cmd/govim/internal/lsp/godef/a.Thing")
*/
