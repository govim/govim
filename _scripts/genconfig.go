...
VIM_VERSIONS="{{.VimVersions}}"
GVIM_VERSIONS="{{.GvimVersions}}"
NEOVIM_VERSIONS="{{.NeovimVersions}}"

MAX_GO_VERSION={{.MaxGoVersion}}
MAX_VIM_VERSION={{.MaxVimVersion}}
MAX_GVIM_VERSION={{.MaxGvimVersion}}
MAX_NEOVIM_VERSION={{.MaxNeovimVersion}}

DEFAULT_VIM_COMMAND={{.VimCommand}}
DEFAULT_GVIM_COMMAND={{.GvimCommand}}
DEFAULT_NEOVIM_COMMAND={{.NeovimCommand}}

VALID_FLAVORS="{{.ValidFlavors}}"
`
